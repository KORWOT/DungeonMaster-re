...
namespace Balance.Editor
{
    ...
    public class WaveDataBalanceEditor : BalanceEditorWindow<WaveData>
    {
        ...
        protected override void DrawFilters()
        {
            ...
            var newTimeFilter = (TimeFilterType)EditorGUILayout.EnumPopup(_timeFilter, GUILayout.Width(100));
            ...
            {
                var newTimeFilterValue = EditorGUILayout.FloatField(_timeFilterValue, GUILayout.Width(50));
                if (newTimeFilterValue != _timeFilterValue)
                {
                    _timeFilterValue = newTimeFilterValue;
                }
            }
        }
