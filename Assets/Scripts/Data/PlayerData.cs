...
namespace Data
{
    ...
    public class PlayerData
    {
        ...
        // public List<BaseDemonLordCard> OwnedDemonLords;
        // public List<BaseDungeonRoom> OwnedRooms;
        
        // 보유 베이스 카드들
        public List<BaseMonsterCard> OwnedBaseCards;
        ...
        public PlayerData()
        {
            ...
            OwnedBaseCards = new List<BaseMonsterCard>();
            SelectedMonsterIds = new List<string>();
            
            // OwnedDemonLords = new List<BaseDemonLordCard>();
            // OwnedRooms = new List<BaseDungeonRoom>();
