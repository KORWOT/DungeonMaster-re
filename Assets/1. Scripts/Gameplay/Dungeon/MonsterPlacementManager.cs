...
namespace DungeonMaster.Gameplay.Dungeon
{
    ...
    public class MonsterPlacementManager
    {
        ...
        private readonly Dictionary<Vector2Int, BaseMonsterCardData> _placedMonsters = new Dictionary<Vector2Int, BaseMonsterCardData>();
        ...
        public bool PlaceMonster(BaseMonsterCardData monster, Vector2Int position)
        {
        ...
        /// </summary>
        public IReadOnlyDictionary<Vector2Int, BaseMonsterCardData> GetPlacedMonsters()
        {
